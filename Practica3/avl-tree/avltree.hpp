...
protected:
  ...
  /**
   * @brief Create a AVLTree given a node as root.
   * Use this method to generate the left/right subtrees.
 ...
 */
template<class T>
typename AVLTree<T>::Ref create_perfectly_balanced_bstree(std::vector<T> & data);
